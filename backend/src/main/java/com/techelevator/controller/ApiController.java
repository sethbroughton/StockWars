...
public class ApiController {
    ...
    @GetMapping("/endgameTest/{today}/{gameId}")
    public boolean testForEndgameCondition(@PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate today, @PathVariable long gameId) {
        return gameDao.testForEndgame(today, gameId);
    }
